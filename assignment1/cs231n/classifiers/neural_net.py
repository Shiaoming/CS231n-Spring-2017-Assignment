...
#    Z1 = W1.transpose().dot(X.transpose()) + b1.reshape(b1.shape[0],-1)
#    A1 = Z1 * (Z1 > 0)
#    Z2 = W2.transpose().dot(A1) + b2.reshape(b2.shape[0],-1)
#    scores = Z2.transpose()
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
...
#    grads['W2'] = dW2 + reg * W2
#    grads['b2'] = db2.reshape(db2.shape[1])
#    grads['W1'] = dW1 + reg * W1
#    grads['b1'] = db1.reshape(db1.shape[1])
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
